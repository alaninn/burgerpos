    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <button onClick={() => setCant({})} className="text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-100 dark:text-gray-400 underline mb-3">Limpiar todo</button>
