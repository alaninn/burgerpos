        ...
        <div className="p-4 md:p-6">
          ...
          {tabActiva === 'Integraciones' && (
            <div className="space-y-6">
              ...
              {/* Respuestas automáticas: ahora en su página dedicada */}
              <Link to="/admin/whatsapp-bot"
                className="mt-6 flex items-center gap-4 border border-violet-200 dark:border-violet-800 rounded-xl p-5 bg-violet-50 dark:bg-violet-950 hover:bg-violet-100 dark:hover:bg-violet-900/40 transition-colors">
                <div className="w-10 h-10 rounded-lg bg-violet-500 flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-4 4v-4z" /></svg>
                </div>
                <div className="flex-1">
                  <p className="text-sm font-semibold text-violet-900 dark:text-violet-100">Asistente automático de WhatsApp</p>
                  <p className="text-xs text-violet-700 dark:text-violet-300">
                    Dale nombre, tono, reglas y preguntas frecuentes, y probalo en vivo. Ahora tiene su propia sección.
                  </p>
                </div>
                <svg className="w-5 h-5 text-violet-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
              </Link>
