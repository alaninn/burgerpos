...
// chico (~400 lineas, ~100KB) para poder verlos desde el panel SuperAdmin
...
/** Devuelve las lineas posteriores a un id (para polling incremental) */
...
/** Vacia el buffer en memoria (p. ej. despues de subir el reporte de errores) */
function limpiar() {
  buffer.length = 0;
}
