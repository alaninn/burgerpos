module.exports = (sequelize, DataTypes) => {
  const Caja = sequelize.define('Caja', {
    ...
    totalMercadopago:    { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
    ...
    tarjetaDeclarada:        { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
    mercadopagoDeclarada:    { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
    transferenciaDeclarada:  { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
