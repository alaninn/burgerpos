...
const { resumen, exportar, tendencia, productos, clientes, repartidores, centroControl } = require('../controllers/reporte.controller');
...
router.get('/centro-control', checkAcceso('reportesAvanzados'), centroControl);
